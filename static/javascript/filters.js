...
function loadFilters(filterData, lastcountry, last_operator){
    ...
    if(filterData.operatorFilterRows != null)
    {
        ...
        for (var i = 0; i < filterData.operatorFilterRows.length; i++) {
            filterParams[0][1].options.add(new Option(filterData.operatorFilterRows[i].Operator_Group_Name,filterData.operatorFilterRows[i].Operator_Group_Name, false, false));
        }
    }
}
